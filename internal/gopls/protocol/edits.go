...
// Note (lightspeed): the upstream file ends with
// SelectCompletionTextEdit, which depends on the CompletionItem and
// InsertReplaceEdit generated types. Completion is out of scope here,
// so that function is omitted from this vendored copy.
